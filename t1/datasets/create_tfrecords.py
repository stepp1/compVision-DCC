...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Create a dataset for training an testing"
    )
    ...
    elif configuration.get_image_type() == "FASHION":
        process_fun = imgproc.process_image
    elif configuration.get_image_type() == "CUSTOM":
        process_fun = imgproc.create_processing_function(
            configuration.get_image_processing_params()
        )
    data.create_tfrecords(configuration, pargs.type, processFun=process_fun)
